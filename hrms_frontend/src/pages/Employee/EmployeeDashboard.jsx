...
const EmployeeDashboard = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const response = await axiosInstance.get(`${API_ENDPOINTS.EMPLOYEE.PROFILE}/${user.employeeId}/profile`);
            ...
            <div className="col-lg-4">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body text-center d-flex flex-column">
                  <div className="rounded-circle bg-primary text-white fw-bold d-inline-flex align-items-center justify-content-center mx-auto mb-3 p-4 fs-2">
